...
%   编译环境：Windows 7 SP1 + TeXLive2017 + TeXStudio
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%\setmainfont[Mapping=tex-text]{Times New Roman}   %如没有Garamond字体，将本行起始%取消，下一行加注释。
...
% --------------- * 设 * 置 * 自 * 定 * 义 * 英 * 文 * 字 * 体 * -----------------
\setCJKfamilyfont{agaramond}{AGaramondPro-Regular}                            %Adobe agaramond
\setCJKfamilyfont{minionpro}{MinionPro-Regular}    
