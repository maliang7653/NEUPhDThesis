...
% -------------- * 字 * 体 * 名 * 称 * 定 * 义 * --------------
%\def\fontMin#1{\def\@fontMin{#1}}\def\@fontMin{}
%\def\fontGara#1{\def\@fontGara{#1}}\def\@fontGara{}
%\def\fontT#1{\def\@fontT{#1}}\def\@fontT{}
%\def\fontArial#1{\def\@fontArial{#1}}\def\@fontArial{}
%\def\fontAsong#1{\def\@fontAsong{#1}}\def\@fontAsong{}
%\def\fontAHei#1{\def\@fontAHei{#1}}\def\@fontAHei{}
%\def\fontAFs#1{\def\@fontAFs{#1}}\def\@fontAFs{}
%\def\fontAKai#1{\def\@fontAKai{#1}}\def\@fontAKai{}
