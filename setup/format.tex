...
% 设置章、节、小节、小小节的间距
\titleformat{\chapter}[hang]{\normalfont\erhao\hei \sf}{第\erhao\thechapter 章}{1em}{\erhao}
\titlespacing{\chapter}{0pt}{-3ex  plus .1ex minus .2ex}{3.3ex}
\titleformat{\section}[hang]{\sanhao\hei\sf}{\sanhao\thesection}{1em}{}{}
...
%    \chead{}
%    \rhead{\kai\wuhao\leftmark}
%    \lhead{\kai\wuhao{东北大学博士学位论文}}
%%    \fancyhead[L]{\kai\wuhao{东北大学博士学位论文}}
%%    \fancyhead[R]{\kai\wuhao\leftmark}
%}
        ...
        \begin{center}
          {\renewcommand{\baselinestretch}{1.61}
            ...
            \begin{tabular}{rl}
              ...
              学 \hfill 位 \hfill 授 \hfill 予 \hfill 日 \hfill 期：& \hspace{1.2cm}年\hspace{.4cm}月\hspace{.1cm}答辩委员会主席：\@funnynameA\\
              评 \hfill 阅 \hfill 人：& \\
            \end{tabular}
          }
        \end{center}
...
%------------------------ * 英 * 文 * 封 * 面 * -------------------------
    \newpage
    \thispagestyle{empty}
    \sihao{\textbf{A Thesis in \@eMajor}}
    \vspace{1.2cm}
    \begin{center}
          {\erhao\textbf{\@etitle}\\}
          \vspace{2.0cm}
...
% ------ * 授 * 权 * 书 * 与 * 独 * 创 * 性 * 声 * 明 * --------
    ...
    {
      \sihao\song
    \hspace{1.2cm} 本人声明，所呈交的学位论文是在导师的指导下完成的。论文中取得的研究成果除加以标注和致谢的地方外，不包含其他人己经发表或撰写过的研究成果，也不包括本人为获得其他学位而使用过的材料。与我一同工作的同志对本研究所做的任何贡献均己在论文中作了明确的说明并表示谢意。\\
      \vspace{0.5cm}
    }
    {\hspace{9cm}学位作者签名：\\\vspace{0.35cm}\hspace{9cm}日\hspace{0.7cm}期：\\}
    \vspace{1.2cm}
    {\center\erhao\hei 学位论文版权使用授权书\\}
    \vspace{0.6cm}
    \sihao\song
     \hspace{1.2cm} 本学位论文作者和指导教师完全了解东北大学有关保留、使用学位论文的规定：即学校有权保留并向国家有关部门或机构送交论文的复印件和磁盘，允许论文被查阅和借阅。本人同意东北大学可以将学位论文的全部或部分内容编入有关数据库进行检索、交流。

        \vspace{1.0cm}

    \hspace{1.2cm} 作者和导师同意网上交流的时间为作者获得学位后：\\
        \vspace{0.7cm}
    \hspace{1.2cm} 半年~$\Box$ \hspace{1cm} 一年~$\Box$ \hspace{1cm} 一年半~$\Box$ \hspace{1cm} 两年~$\Box$
    \end{flushleft}
    \vspace{0.7cm}
\noindent
    \begin{tabular}{llll}
...
%    {\sihao\song \hspace{9cm}学位作者签名：\\}
%    {\hspace{9cm}日\hspace{1cm}期：\\}
%    \vspace{1cm}
%  \end{center}
%  \renewcommand{\baselinestretch}{1.27}
%  \cleardoublepage
